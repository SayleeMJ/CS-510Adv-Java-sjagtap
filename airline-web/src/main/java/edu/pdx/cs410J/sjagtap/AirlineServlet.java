...
import edu.pdx.cs410J.core.SimpleDate;
...
public class AirlineServlet extends HttpServlet {
    ...
    /**
     * Handles an HTTP GET request from a client by writing the dictionary of the
     * airline specified in the "airline" HTTP parameter to the HTTP response. If the
     * "airline" parameter is not specified, all the entries in the dictionary
     ...
     * "airline" and details of flight as request parameters. It writes the dictionary
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // Checking if the airline provided is already existed in to hashmap
        ...
        printWriter.println(Messages.definedAirlineAs(airline, flight));
        printWriter.flush();
    ...
    /**
     * Writes the definition of the given word into Xml format to the HTTP response.
     * <p>
     * The xml format is formatted with {@link XmlDumper}
     */
    ...
    private void writeAllAirlineEntries(HttpServletResponse response) throws IOException {
        ...
        XmlDumper dumper = new XmlDumper(outputStream);

        for (Airline airline : this.airlineDictionary.values()) {
            dumper.dump(airline);
        }
